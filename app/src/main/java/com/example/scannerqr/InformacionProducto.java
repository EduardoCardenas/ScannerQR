...
public class InformacionProducto extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id==R.id.home){
            startActivity(new Intent(InformacionProducto.this, Bienvenido.class));
        }else{
            if(id==R.id.buscar){
                startActivity(new Intent(InformacionProducto.this, ModificarProducto.class));
            }else {
                if (id == R.id.registrar) {
                    startActivity(new Intent(InformacionProducto.this, RegistrarProducto.class));
                } else {
                    if (id == R.id.salir) {
