...
public class ModificarProducto extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            startActivity(new Intent(ModificarProducto.this, Bienvenido.class));
        } else {
            if (id == R.id.buscar) {
                startActivity(new Intent(ModificarProducto.this, ModificarProducto.class));
            } else {
                if (id == R.id.registrar) {
                    startActivity(new Intent(ModificarProducto.this, RegistrarProducto.class));
                } else {
                    if (id == R.id.salir) {
                        ...
                        startActivity(new Intent(ModificarProducto.this, LoginActivity.class));
                        finish();
                    }
